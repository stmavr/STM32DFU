...
#define ADDRES_SERIAL_NUMBER (0x080FF000)
uint8_t qwe[16] = {0x31, 0, 0x32, 0, 0x33, 0, 0x34, 0, 0x35, 0, 0x36, 0, 0x37, 0, 0x38, 0};
...
//  }
    ...
    {
    	USBD_StringSerial[i + 2] = qwe[i];//*((uint8_t*)(ADDRES_SERIAL_NUMBER + i));
    }
}
